...
class Analysis:
    ...
    def __init__(self, user="codinguser", repo="gnucash-android"):
        ...
        self.filetypes = [".java", ".xml", ".gradle", ".jar", ".so", ".aar", "png", "jpg", ".keystore", ".zip", ".rar",
                          ...
                          "gradlew", ".sh", "yaml", "CONTRIBUTORS", "LICENSE", ".gnucash", "other"]
        self.filetypesmap = {}
        ...
        self.others = set([])
        self.diffflist = open(os.path.join(self.pyg.data_dir, 'diff_intent_text'), 'a')
    ...
    def javaresultreduceone(self):
        ...
        for jfk, jfv in self.javafilenamesmap.items():
            if re.search("Activity.java", jfk, re.I):
                ...
                result["CrawlingScript"] = result.get("CrawlingScript", 0) + jfv
            else:
    ...
    def javaresultreducetwo(self):
        ...
        for jfk in self.javafilenamesmap.keys():
            if re.search("Activity.java", jfk, re.I):
                ...
                result["CrawlingScript"] = result.get("CrawlingScript", 0) + 1
            else:
