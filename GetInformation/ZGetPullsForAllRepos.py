    ...
    def log(self,item):
        ...
        with open(self.logfile, 'r') as load_f:
            ...
            with open(self.logfile, "w") as dump_f:
                json.dump(load_dict, dump_f)
    def initlog(self):
        self.logfile=os.path.join(GetFilePathRoot.get_root_dir(), "data", "GetAllPulls.txt")
        self.log(None)
        self.outputfile = os.path.join(GetFilePathRoot.get_root_dir(), "data", "GetAllPullsOutput.txt")
        import logging
        # 创建一个logger
