...
class FindAndroidRepos:
    '爬取类'
    count = 0
    resultfile = os.path.join(GetFilePathRoot.get_root_dir(), "data", "Find.csv")
    ...
    def initlog(self):
        ...
        self.outputfile = os.path.join(GetFilePathRoot.get_root_dir(),"data","FindOutput.txt")
        ...
        while True:
            ...
            for result in results["items"]:
                ...
                try:
                    ...
                    contents = r.json()
                    if len(contents)>0:
                        check_url= contents[0]["commit"]["tree"]["url"]+"?recursive=10"
                        print check_url
