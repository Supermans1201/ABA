...
class GithubRepo:
    ...
    def init_processing_corpus_filepath(self):
        ...
        self.diffxmlfilepath = os.path.join(self.data_dir, "corpus",self.diffxmlfilename)
        self.diffpredealxmlfilepath = os.path.join(self.data_dir,"corpus",self.diffpredealxmlfilename)
        self.directoryxmlfilepath = os.path.join(self.data_dir,"corpus",self.directoryxmlfilename)
        self.diffmodelxmlfilepath = os.path.join(self.data_dir,"corpus",self.diffmodelxmlfilename)
    ...
    def init_mongodb_coll(self):
        ...
        self.issues_info2_coll = self.openmongdb("issuesinfo2")
